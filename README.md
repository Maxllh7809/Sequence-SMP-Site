...
* **Server Status & Player List:** One-click button to copy the Server IP (`sequence.playmc.cloud`). **Hover over the online count** to see a live list of connected players and their avatars.
...
```javascript
// Use /3/ for Java Edition or /bedrock/3/ for Bedrock servers
...
1.  Clone the repository:
    ```bash
    git clone [https://github.com/Maxllh7809/Sequence-SMP-Site.git](https://github.com/Maxllh7809/Sequence-SMP-Site.git)
    ```
